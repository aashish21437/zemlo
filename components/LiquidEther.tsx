...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class Simulation {
      ...
      update() {
        this.boundarySpace = this.options.isBounce ? new THREE.Vector2(0,0) : this.cellScale.clone();
    ...
    if (webgl.output?.simulation) {
      Object.assign(webgl.output.simulation.options, { mouse_force: mouseForce, cursor_size: cursorSize, isViscous, viscous, iterations_viscous: iterationsViscous, iterations_poisson: iterationsPoisson, dt, BFECC, resolution, isBounce });
    }
    webgl.start();
  ...
  return (
    <div
      ...
      style={{ pointerEvents: 'none', touchAction: 'none', ...style }}
    />
  );
}
