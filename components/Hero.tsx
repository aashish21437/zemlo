...
// Dynamically import LiquidEther (WebGL) so it never SSR-crashes
...
export default function Hero() {
  return (
    <>
      {/* --- HERO SECTION --- */}
      <section id="hero" className="relative pt-40 pb-20 px-6 sm:px-10 lg:px-16 container mx-auto overflow-hidden">

        {/* LiquidEther — dark mode only, behind all hero content */}
